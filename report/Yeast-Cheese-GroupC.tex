...
\begin{description}
%\item[Quality Control] After receiving the raw data, we used the FastQC tool to assess the quality of the reads. The contents of Table~\ref{tab:yeastfiles} was taken from this step. 
